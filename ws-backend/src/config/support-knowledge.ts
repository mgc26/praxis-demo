...
export const SUPPORT_PATHWAYS: Record<SupportPathway, SupportPathwayDefinition> = {
  ...
  'nurse-educator': {
    id: 'nurse-educator',
    name: 'Nurse Educator Coordination',
    ...
    urgencyLevel: 'routine',
    suggestedResources: ['Nurse Educator Team', 'Patient Education Materials', 'Caregiver Support Program'],
    keyTalkingPoints: [
      'Our nurse educators specialize in your treatment area and can provide one-on-one guidance.',
      'A nurse educator can walk you through your titration schedule and what to expect.',
      'We can schedule a session at a time that works for you — morning or afternoon.',
      'Your nurse educator can also coordinate directly with your prescribing physician if needed.',
    ],
    escalationCriteria: [
      'Patient or caregiver requests immediate clinical guidance beyond support scope',
      'New patient on complex titration schedule needing hands-on education',
      'Caregiver needs training on seizure management or emergency medication administration',
      'Patient reports confusion about dosing or treatment plan',
    ],
  },
};
